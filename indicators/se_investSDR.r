...
# Paths ----------------------------------------------------------------------------
    ...
    erosivity_path <- "envirospace/projects/GE21/IE/..."
    ...
    erodibility_path <- "envirospace/projects/GE21/IE/..."
...
# Parameters ------------------------------------------------------------------------
    ...
    description <- paste0("Capacité des éléments naturels à limiter l'érosion, donc a retenir les sédiements (modèle InVEST).", "\n", 
                          "http://releases.naturalcapitalproject.org/invest-userguide/latest/en/sdr.html#")
...
tryCatch({
    ...
    # 1.4) Load and prepare data --------------------------------------------------------
        ...
        info <- c(info, paste0("INPUTS : ", "\n",
                               ...
                               " * Raster DEM : ", dem_path, "\n",
                               " * Raster érosivité par les précipitations : ", erosivity_path, "\n", 
                               " * Raster érodibilité du sol : ", erodibility_path, "\n", 
